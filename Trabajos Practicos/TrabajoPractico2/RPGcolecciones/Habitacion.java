...
/* Informatica Avanzada - 2021 */
    ...
    {
        if(elemento == null || elemento.getNombre() == null) return;

        if(TipoElemento.LIQUIDO.equals(elemento.getTipo()))
        {
    ...
    public Elemento getElemento (String nombre) 
    {
        ...
        if(TipoElemento.FIJO.equals(elementos.get(nombre).getTipo()))
        {
    ...
    protected String getStringDeElementos ()
    {
        ...
        String cadenaElementos = "Elementos:";
